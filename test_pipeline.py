...
sim_settings.start_date = "2026-08-16T12:00:00"
sim_settings.end_date   = "2027-08-16T12:00:00"
...
sc = esmat.Spacecraft.from_keplerian(
    ...
    true_anomaly=0.0000,
    state_vector_epoch_utc="2026-08-16T12:00:00",
    mission_start_epoch_utc="2026-08-16T12:00:00"
)
...
esmatpy.print_burn_table(burn_table, export_csv_path="mission_plan.csv")
